              ...
              <div className="bg-vista-white rounded-2xl p-6 border border-gray-200">
                ...
                <div className="space-y-6">
                    ...
                    <EnhancedInput
                      ...
                      required
                      success={formData.phone && formData.phone.length === 14}
                      icon={
                        <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <EnhancedInput
                      ...
                      required
                      success={formData.linkedin && formData.linkedin.length > 28 && formData.linkedin !== 'https://linkedin.com/in/'}
              ...
              <div className="bg-vista-white rounded-2xl p-6 border border-gray-200">
                ...
                <div>
                    <EnhancedInput
                      ...
                      success={formData.github && formData.github.length > 19 && formData.github !== 'https://github.com/'}
                      icon={
                        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
